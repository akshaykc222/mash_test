...
import '../core/connection_checker.dart' as _i28;
import '../core/firebase_database.dart' as _i7;
import '../core/hive_service.dart' as _i8;
import '../mash/data/local/data_sources/auth_local_data_source.dart' as _i27;
...
import '../mash/data/remote/data_sources/academic_remote_data_source.dart'
    as _i10;
import '../mash/data/remote/data_sources/auth_remote_data_source.dart' as _i31;
...
import '../mash/domain/repositories/drawer_menu_items_repository.dart' as _i25;
...
import '../mash/domain/use_cases/dashboard/get_digital_library_use_case.dart'
    as _i54;
import '../mash/domain/use_cases/dashboard/get_role_menu_usecase.dart' as _i57;
...
import '../mash/domain/use_cases/notice/notice_all_usecase.dart' as _i55;
...
import '../mash/domain/use_cases/profile/get_user_details_use_case.dart'
    as _i20;
import '../mash/domain/use_cases/profile/update_profile_use_case.dart' as _i21;
import '../mash/presentation/manager/academic_bloc/academic_bloc.dart' as _i67;
...
import '../mash/presentation/manager/dashboard_bloc/dashboard_bloc.dart'
    as _i69;
import '../mash/presentation/manager/drawer_bloc/drawer_bloc.dart' as _i68;
import '../mash/presentation/manager/home_work_notes_bloc/home_work_notes_bloc.dart'
    as _i66;
import '../mash/presentation/manager/notice_bloc/notice_bloc.dart' as _i65;
import '../mash/presentation/manager/profile_bloc/profile_bloc.dart' as _i5;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i21.UpdateProfileUseCase>(
        () => _i21.UpdateProfileUseCase(gh<_i14.ProfileRepository>()));
    gh.lazySingleton<_i22.DashBoardRemoteDataSource>(() =>
        _i22.DashBoardRemoteDataSourceImpl(apiProvider: gh<_i6.ApiProvider>()));
    gh.factory<_i23.GetAcademicSubjectUseCase>(() =>
        _i23.GetAcademicSubjectUseCase(
            academicRepostory: gh<_i17.AcademicRepository>()));
    gh.factory<_i24.GetDivisionDetailsUseCase>(() =>
        _i24.GetDivisionDetailsUseCase(
            academicRepostory: gh<_i17.AcademicRepository>()));
    gh.lazySingleton<_i25.DrawerMenuItemsRepository>(() =>
        _i26.DrawerMenuItemsRepositoryImpl(
            drawerMenuItemsRemoteDataSource:
                gh<_i16.DrawerMenuItemsRemoteDataSource>()));
    gh.lazySingleton<_i27.AuthLocalDataSource>(
        () => _i27.AuthLocalDataSourceImpl(hiveService: gh<_i8.HiveService>()));
    gh.lazySingleton<_i28.ConnectionChecker>(
        () => _i28.ConnectionCheckerImpl(gh<_i29.InternetConnectionChecker>()));
    gh.lazySingleton<_i30.HomeWorkNotesRemoteDataSource>(() =>
        _i30.HomeWorkRemoteDataSourceImpl(apiProvider: gh<_i6.ApiProvider>()));
    gh.lazySingleton<_i31.AuthRemoteDataSource>(
        () => _i31.AuthRemoteDataSourceImpl(
              gh<_i6.ApiProvider>(),
              gh<_i7.FirebaseDatabaseMethods>(),
            ));
    gh.lazySingleton<_i32.NoticeRemoteDataSource>(() =>
        _i32.NoticeRemoteDataSourceImpl(apiProvider: gh<_i6.ApiProvider>()));
    gh.lazySingleton<_i33.DashBoardLocalDataSource>(() =>
        _i33.DashBoardLocalDataSourceImpl(hiveService: gh<_i8.HiveService>()));
    ...
    gh.lazySingleton<_i36.GetNewsBoardUseCase>(() => _i36.GetNewsBoardUseCase(
        drawerMenuItemsRepository: gh<_i25.DrawerMenuItemsRepository>()));
    ...
    gh.lazySingleton<_i46.HomeWorkNotesRepository>(() =>
        _i47.HomeWorkNotesReportRepositoryImpl(
            homeWorkNotesRemoteDataSource:
                gh<_i30.HomeWorkNotesRemoteDataSource>()));
    gh.lazySingleton<_i48.DashBoardRepository>(() => _i49.DashBoardRepoImpl(
          gh<_i22.DashBoardRemoteDataSource>(),
          gh<_i28.ConnectionChecker>(),
          gh<_i33.DashBoardLocalDataSource>(),
        ));
    gh.lazySingleton<_i50.AuthRepository>(() => _i51.AuthRepositoryImpl(
          gh<_i28.ConnectionChecker>(),
          authRemoteDataSource: gh<_i31.AuthRemoteDataSource>(),
          authLocalDataSource: gh<_i27.AuthLocalDataSource>(),
        ));
    gh.lazySingleton<_i52.NoticeRepository>(() => _i53.NoticeRepositoryImpl(
        noticeRemoteDataSource: gh<_i32.NoticeRemoteDataSource>()));
    gh.singleton<_i54.DigitalLibraryUseCase>(
        () => _i54.DigitalLibraryUseCase(gh<_i48.DashBoardRepository>()));
    gh.factory<_i55.GetAllNoticeUseCase>(() => _i55.GetAllNoticeUseCase(
        noticeRepository: gh<_i52.NoticeRepository>()));
    gh.factory<_i56.FetchWordThoughtUseCase>(
        () => _i56.FetchWordThoughtUseCase(gh<_i48.DashBoardRepository>()));
    gh.factory<_i57.GetRoleMenuUsecase>(
        () => _i57.GetRoleMenuUsecase(gh<_i48.DashBoardRepository>()));
    gh.lazySingleton<_i58.HomeWorkReportsUseCase>(() =>
        _i58.HomeWorkReportsUseCase(
            homeWorkNotesRepository: gh<_i46.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i59.NotesReportsUseCase>(() => _i59.NotesReportsUseCase(
        homeWorkNotesRepository: gh<_i46.HomeWorkNotesRepository>()));
    ...
    gh.factory<_i68.DrawerBloc>(() => _i68.DrawerBloc(
          ...
          gh<_i62.GetUserInfoUseCase>(),
          gh<_i57.GetRoleMenuUsecase>(),
        ));
    gh.factory<_i69.DashboardBloc>(() => _i69.DashboardBloc(
          gh<_i56.FetchWordThoughtUseCase>(),
          gh<_i62.GetUserInfoUseCase>(),
        ));
    return this;
  }
