...
import '../mash/domain/use_cases/auth/get_user_info_use_case.dart' as _i71;
import '../mash/domain/use_cases/auth/login_use_case.dart' as _i72;
import '../mash/domain/use_cases/auth/save_user_info_use_case.dart' as _i73;
import '../mash/domain/use_cases/auth/sign_out_use_case.dart' as _i70;
...
import '../mash/domain/use_cases/dashboard/fetch_word_thought_usecase.dart'
    as _i65;
import '../mash/domain/use_cases/dashboard/get_role_menu_usecase.dart' as _i66;
...
import '../mash/domain/use_cases/home_work_notes/get_notes_reports_use_case_report.dart'
    as _i68;
import '../mash/domain/use_cases/notice/get_notice_pop_up_usecase.dart' as _i69;
import '../mash/domain/use_cases/notice/notice_all_usecase.dart' as _i64;
...
import '../mash/domain/use_cases/vehicle_tracker_stops/vehicle_tracker_stops_usecase.dart'
    as _i41;
import '../mash/presentation/manager/academic_bloc/academic_bloc.dart' as _i76;
...
import '../mash/presentation/manager/dashboard_bloc/dashboard_bloc.dart'
    as _i78;
import '../mash/presentation/manager/drawer_bloc/drawer_bloc.dart' as _i77;
import '../mash/presentation/manager/home_work_notes_bloc/home_work_notes_bloc.dart'
    as _i75;
import '../mash/presentation/manager/notice_bloc/notice_bloc.dart' as _i74;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i75.HomeWorkNotesBloc>(() => _i75.HomeWorkNotesBloc(
          gh<_i67.HomeWorkReportsUseCase>(),
          gh<_i71.GetUserInfoUseCase>(),
          gh<_i68.NotesReportsUseCase>(),
        ));
    gh.factory<_i76.AcademicBloc>(() => _i76.AcademicBloc(
          gh<_i30.GetDivisionDetailsUseCase>(),
          getClassInforUseCase: gh<_i47.GetClassInforUseCase>(),
          getUserInfoUseCase: gh<_i71.GetUserInfoUseCase>(),
    ...
    gh.factory<_i77.DrawerBloc>(() => _i77.DrawerBloc(
          gh<_i44.GetNewsBoardUseCase>(),
          gh<_i71.GetUserInfoUseCase>(),
          gh<_i66.GetRoleMenuUsecase>(),
        ));
