...
import '../mash/domain/use_cases/auth/get_user_info_use_case.dart' as _i77;
import '../mash/domain/use_cases/auth/login_use_case.dart' as _i78;
import '../mash/domain/use_cases/auth/save_user_info_use_case.dart' as _i79;
import '../mash/domain/use_cases/auth/sign_out_use_case.dart' as _i76;
...
import '../mash/domain/use_cases/id_request/id_request_type_usecase.dart'
    as _i69;
import '../mash/domain/use_cases/notice/get_notice_pop_up_usecase.dart' as _i75;
...
import '../mash/presentation/manager/bloc/academic_bloc/academic_bloc.dart'
    as _i82;
import '../mash/presentation/manager/bloc/auth_bloc/auth_bloc.dart' as _i5;
import '../mash/presentation/manager/bloc/chat_bloc/chat_bloc.dart' as _i6;
...
import '../mash/presentation/manager/bloc/home_work_notes_bloc/home_work_notes_bloc.dart'
    as _i81;
import '../mash/presentation/manager/bloc/notice_bloc/notice_bloc.dart' as _i80;
import '../mash/presentation/manager/bloc/profile/profile_bloc.dart' as _i7;
import '../mash/presentation/manager/id_request/id_request_bloc.dart' as _i4;
import '../mash/presentation/manager/teacher_bloc/teacher_bloc.dart' as _i3;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i4.IdRequestBloc>(() => _i4.IdRequestBloc());
    ...
    gh.lazySingleton<_i74.GetNoteReportDetails>(() => _i74.GetNoteReportDetails(
        homeWorkNotesRepository: gh<_i60.HomeWorkNotesRepository>()));
    gh.factory<_i75.GetNoticeBoardPopUp>(
        () => _i75.GetNoticeBoardPopUp(gh<_i66.NoticeRepository>()));
    gh.singleton<_i76.SignOutUseCase>(
        () => _i76.SignOutUseCase(gh<_i64.AuthRepository>()));
    gh.lazySingleton<_i77.GetUserInfoUseCase>(
        () => _i77.GetUserInfoUseCase(gh<_i64.AuthRepository>()));
    gh.lazySingleton<_i78.LoginUseCase>(
        () => _i78.LoginUseCase(gh<_i64.AuthRepository>()));
    gh.lazySingleton<_i79.SaveUserInfoUseCase>(
        () => _i79.SaveUserInfoUseCase(gh<_i64.AuthRepository>()));
    gh.factory<_i80.NoticeBloc>(() => _i80.NoticeBloc(
          gh<_i75.GetNoticeBoardPopUp>(),
          gh<_i68.GetAllNoticeUseCase>(),
        ));
    gh.factory<_i81.HomeWorkNotesBloc>(() => _i81.HomeWorkNotesBloc(
          gh<_i72.HomeWorkReportsUseCase>(),
          gh<_i77.GetUserInfoUseCase>(),
          gh<_i73.NotesReportsUseCase>(),
          gh<_i74.GetNoteReportDetails>(),
        ));
    gh.factory<_i82.AcademicBloc>(() => _i82.AcademicBloc(
          gh<_i32.GetDivisionDetailsUseCase>(),
          getClassInforUseCase: gh<_i49.GetClassInforUseCase>(),
          getUserInfoUseCase: gh<_i77.GetUserInfoUseCase>(),
    ...
    gh.factory<_i83.DrawerBloc>(() => _i83.DrawerBloc(
          gh<_i46.GetNewsBoardUseCase>(),
          gh<_i77.GetUserInfoUseCase>(),
          gh<_i71.GetRoleMenuUsecase>(),
        ));
    gh.factory<_i84.DashboardBloc>(() => _i84.DashboardBloc(
