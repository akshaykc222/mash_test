...
import '../mash/domain/use_cases/auth/save_user_info_use_case.dart' as _i123;
...
import '../mash/domain/use_cases/chat/update_message_use_case.dart' as _i87;
...
import '../mash/domain/use_cases/id_request/id_request_type_usecase.dart'
    as _i111;
import '../mash/domain/use_cases/id_request/post_id_request.dart' as _i110;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i87.UpdateMessageUseCase>(
        () => _i87.UpdateMessageUseCase(gh<_i33.ChatRepository>()));
    ...
    gh.lazySingleton<_i92.GetOfflineExamTimeTableUseCase>(() =>
        _i92.GetOfflineExamTimeTableUseCase(gh<_i30.TimeTableRepository>()));
    ...
    gh.lazySingleton<_i97.DigitalLibraryUseCase>(
        () => _i97.DigitalLibraryUseCase(gh<_i39.AcademicRepository>()));
    ...
    gh.lazySingleton<_i110.PostIdRequestUseCase>(
        () => _i110.PostIdRequestUseCase(gh<_i77.IdRequestRepository>()));
    ...
    gh.factory<_i113.GetTermDetailsUsecase>(
        () => _i113.GetTermDetailsUsecase(gh<_i103.DashBoardRepository>()));
    ...
    gh.factory<_i115.GetRoleMenuUsecase>(
        () => _i115.GetRoleMenuUsecase(gh<_i103.DashBoardRepository>()));
    gh.lazySingleton<_i116.NotesReportsUseCase>(() => _i116.NotesReportsUseCase(
    ...
    gh.lazySingleton<_i117.HomeWorkReportsUseCase>(() =>
        _i117.HomeWorkReportsUseCase(
            homeWorkNotesRepository: gh<_i95.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i118.GetNoteReportDetails>(() =>
        _i118.GetNoteReportDetails(
            homeWorkNotesRepository: gh<_i95.HomeWorkNotesRepository>()));
    ...
    gh.lazySingleton<_i123.SaveUserInfoUseCase>(
        () => _i123.SaveUserInfoUseCase(gh<_i105.AuthRepository>()));
    gh.lazySingleton<_i124.LoginUseCase>(
        () => _i124.LoginUseCase(gh<_i105.AuthRepository>()));
    ...
    gh.factory<_i126.DashboardBloc>(() => _i126.DashboardBloc(
          ...
          gh<_i122.GetUserInfoUseCase>(),
          gh<_i113.GetTermDetailsUsecase>(),
    ...
    gh.factory<_i131.HomeWorkNotesBloc>(() => _i131.HomeWorkNotesBloc(
          ...
          gh<_i122.GetUserInfoUseCase>(),
          gh<_i116.NotesReportsUseCase>(),
          gh<_i118.GetNoteReportDetails>(),
