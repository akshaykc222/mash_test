...
import '../mash/domain/use_cases/auth/get_user_info_use_case.dart' as _i78;
import '../mash/domain/use_cases/auth/login_use_case.dart' as _i79;
import '../mash/domain/use_cases/auth/save_user_info_use_case.dart' as _i80;
import '../mash/domain/use_cases/auth/sign_out_use_case.dart' as _i77;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i77.SignOutUseCase>(
        () => _i77.SignOutUseCase(gh<_i64.AuthRepository>()));
    gh.lazySingleton<_i78.GetUserInfoUseCase>(
        () => _i78.GetUserInfoUseCase(gh<_i64.AuthRepository>()));
    gh.lazySingleton<_i79.LoginUseCase>(
        () => _i79.LoginUseCase(gh<_i64.AuthRepository>()));
    gh.lazySingleton<_i80.SaveUserInfoUseCase>(
        () => _i80.SaveUserInfoUseCase(gh<_i64.AuthRepository>()));
    gh.factory<_i81.NoticeBloc>(() => _i81.NoticeBloc(
          gh<_i76.GetNoticeBoardPopUp>(),
    ...
    gh.factory<_i82.AcademicBloc>(() => _i82.AcademicBloc(
          ...
          getUserInfoUseCase: gh<_i78.GetUserInfoUseCase>(),
