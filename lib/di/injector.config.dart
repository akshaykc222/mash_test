...
import '../mash/data/repositories/auth_repository_impl.dart' as _i114;
import '../mash/data/repositories/chat_repository_impl.dart' as _i34;
import '../mash/data/repositories/dash_board_repository_impl.dart' as _i111;
...
import '../mash/data/repositories/home_work_repository_impl.dart' as _i103;
...
import '../mash/data/repositories/notice_repository_impl.dart' as _i118;
...
import '../mash/domain/repositories/auth_repository.dart' as _i113;
import '../mash/domain/repositories/chat_repository.dart' as _i33;
import '../mash/domain/repositories/dash_board_repository.dart' as _i110;
...
import '../mash/domain/repositories/home_work_notes_repository.dart' as _i102;
...
import '../mash/domain/repositories/notice_repository.dart' as _i117;
...
import '../mash/domain/use_cases/add_on/get_add_on_detail_use_case.dart'
    as _i116;
import '../mash/domain/use_cases/add_on/get_add_on_list_usecase.dart' as _i115;
import '../mash/domain/use_cases/auth/get_user_info_use_case.dart' as _i134;
import '../mash/domain/use_cases/auth/login_use_case.dart' as _i135;
import '../mash/domain/use_cases/auth/save_user_info_use_case.dart' as _i136;
import '../mash/domain/use_cases/auth/sign_out_use_case.dart' as _i133;
import '../mash/domain/use_cases/chat/add_chat_room_use_case.dart' as _i93;
import '../mash/domain/use_cases/chat/get_chat_rooms_use_case.dart' as _i91;
import '../mash/domain/use_cases/chat/get_chat_use_case.dart' as _i94;
import '../mash/domain/use_cases/chat/get_group_members_use_case.dart' as _i95;
import '../mash/domain/use_cases/chat/get_users_use_case.dart' as _i96;
import '../mash/domain/use_cases/chat/send_message_use_case.dart' as _i92;
import '../mash/domain/use_cases/chat/update_message_use_case.dart' as _i97;
import '../mash/domain/use_cases/chat/update_room_use_case.dart' as _i98;
import '../mash/domain/use_cases/dashboard/fetch_word_thought_usecase.dart'
    as _i123;
import '../mash/domain/use_cases/dashboard/get_role_menu_usecase.dart' as _i124;
...
import '../mash/domain/use_cases/id_request/id_request_type_usecase.dart'
    as _i121;
import '../mash/domain/use_cases/id_request/post_id_request.dart' as _i122;
import '../mash/domain/use_cases/leave/leave_use_case.dart' as _i106;
...
import '../mash/domain/use_cases/notice/get_notice_pop_up_usecase.dart'
    as _i131;
import '../mash/domain/use_cases/notice/notice_all_usecase.dart' as _i120;
...
import '../mash/presentation/manager/bloc/academic_bloc/academic_bloc.dart'
    as _i140;
import '../mash/presentation/manager/bloc/addon_bloc/add_on_bloc.dart' as _i132;
...
import '../mash/presentation/manager/bloc/facilities_bloc/facilities_bloc.dart'
    as _i119;
import '../mash/presentation/manager/bloc/home_bloc/home_bloc.dart' as _i137;
...
import '../mash/presentation/manager/bloc/notice_bloc/notice_bloc.dart'
    as _i139;
import '../mash/presentation/manager/bloc/payment/payment_bloc.dart' as _i143;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i85.GetPaymentCompleteResponseUsecase>(() =>
        _i85.GetPaymentCompleteResponseUsecase(gh<_i47.PaymentRepository>()));
    gh.factory<_i86.GetPaymentDashboardUsecase>(
        () => _i86.GetPaymentDashboardUsecase(gh<_i47.PaymentRepository>()));
    gh.factory<_i87.GetPaymentFeeReceiptUsecase>(
        () => _i87.GetPaymentFeeReceiptUsecase(gh<_i47.PaymentRepository>()));
    gh.factory<_i88.GetPaymentTokenUsecase>(
        () => _i88.GetPaymentTokenUsecase(gh<_i47.PaymentRepository>()));
    gh.factory<_i89.PostPaymentStatusUpdateUsecase>(() =>
        _i89.PostPaymentStatusUpdateUsecase(gh<_i47.PaymentRepository>()));
    gh.factory<_i90.SavePaymentResponseUsecase>(
        () => _i90.SavePaymentResponseUsecase(gh<_i47.PaymentRepository>()));
    gh.singleton<_i91.GetChatRoomsUseCase>(
        () => _i91.GetChatRoomsUseCase(gh<_i33.ChatRepository>()));
    gh.singleton<_i92.SendMessageUserCase>(
        () => _i92.SendMessageUserCase(gh<_i33.ChatRepository>()));
    gh.factory<_i93.AddChatRoomUseCase>(
        () => _i93.AddChatRoomUseCase(gh<_i33.ChatRepository>()));
    gh.factory<_i94.GetChatUseCase>(
        () => _i94.GetChatUseCase(gh<_i33.ChatRepository>()));
    gh.factory<_i95.GetUserMembersUseCase>(
        () => _i95.GetUserMembersUseCase(gh<_i33.ChatRepository>()));
    gh.factory<_i96.GetUsersUseCase>(
        () => _i96.GetUsersUseCase(gh<_i33.ChatRepository>()));
    gh.factory<_i97.UpdateMessageUseCase>(
        () => _i97.UpdateMessageUseCase(gh<_i33.ChatRepository>()));
    gh.factory<_i98.UpdateRoomUseCase>(
        () => _i98.UpdateRoomUseCase(gh<_i33.ChatRepository>()));
    gh.lazySingleton<_i99.GetDailyTimeTableUseCase>(
        () => _i99.GetDailyTimeTableUseCase(gh<_i30.TimeTableRepository>()));
    gh.lazySingleton<_i100.GetOfflineExamTermsUseCase>(
        () => _i100.GetOfflineExamTermsUseCase(gh<_i30.TimeTableRepository>()));
    gh.lazySingleton<_i101.GetOfflineExamTimeTableUseCase>(() =>
        _i101.GetOfflineExamTimeTableUseCase(gh<_i30.TimeTableRepository>()));
    gh.lazySingleton<_i102.HomeWorkNotesRepository>(() =>
        _i103.HomeWorkNotesReportRepositoryImpl(
            homeWorkNotesRemoteDataSource:
                gh<_i59.HomeWorkNotesRemoteDataSource>()));
    gh.lazySingleton<_i104.GetAcademicTypesUseCase>(
        () => _i104.GetAcademicTypesUseCase(gh<_i39.AcademicRepository>()));
    gh.lazySingleton<_i105.DigitalLibraryUseCase>(
        () => _i105.DigitalLibraryUseCase(gh<_i39.AcademicRepository>()));
    gh.lazySingleton<_i106.GetDashboardLeaveUseCase>(
        () => _i106.GetDashboardLeaveUseCase(gh<_i75.LeaveRepository>()));
    gh.lazySingleton<_i107.GetPhysicalLibraryUseCase>(
        () => _i107.GetPhysicalLibraryUseCase(gh<_i42.LibraryRepository>()));
    gh.lazySingleton<_i108.PostPhysicalLibraryUseCase>(
        () => _i108.PostPhysicalLibraryUseCase(gh<_i42.LibraryRepository>()));
    gh.lazySingleton<_i109.GetRequiredPhysicalLibraryDataUseCase>(() =>
        _i109.GetRequiredPhysicalLibraryDataUseCase(
            gh<_i42.LibraryRepository>()));
    gh.lazySingleton<_i110.DashBoardRepository>(() => _i111.DashBoardRepoImpl(
          gh<_i49.DashBoardRemoteDataSource>(),
          gh<_i55.ConnectionChecker>(),
          gh<_i67.DashBoardLocalDataSource>(),
        ));
    gh.lazySingleton<_i112.GetFacilitiesDashBoardUseCase>(() =>
        _i112.GetFacilitiesDashBoardUseCase(
    ...
    gh.lazySingleton<_i115.GetAllAddOnUseCase>(() => _i115.GetAllAddOnUseCase(
        getAddOnRepository: gh<_i65.GetAddOnRepository>()));
    gh.lazySingleton<_i116.GetAddOnDetailUseCase>(() =>
        _i116.GetAddOnDetailUseCase(
            getAddOnRepository: gh<_i65.GetAddOnRepository>()));
    gh.lazySingleton<_i117.NoticeRepository>(() => _i118.NoticeRepositoryImpl(
        noticeRemoteDataSource: gh<_i64.NoticeRemoteDataSource>()));
    gh.factory<_i119.FacilitiesBloc>(
        () => _i119.FacilitiesBloc(gh<_i112.GetFacilitiesDashBoardUseCase>()));
    gh.lazySingleton<_i120.GetAllNoticeUseCase>(() => _i120.GetAllNoticeUseCase(
        noticeRepository: gh<_i117.NoticeRepository>()));
    gh.lazySingleton<_i121.GetIdRequestTypeUseCase>(
        () => _i121.GetIdRequestTypeUseCase(gh<_i83.IdRequestRepository>()));
    gh.lazySingleton<_i122.PostIdRequestUseCase>(
        () => _i122.PostIdRequestUseCase(gh<_i83.IdRequestRepository>()));
    gh.factory<_i123.FetchWordThoughtUseCase>(
        () => _i123.FetchWordThoughtUseCase(gh<_i110.DashBoardRepository>()));
    gh.factory<_i124.GetRoleMenuUsecase>(
        () => _i124.GetRoleMenuUsecase(gh<_i110.DashBoardRepository>()));
    gh.factory<_i125.GetScoreboardDetailsUsecase>(() =>
        _i125.GetScoreboardDetailsUsecase(gh<_i110.DashBoardRepository>()));
    gh.factory<_i126.GetTermDetailsUsecase>(
        () => _i126.GetTermDetailsUsecase(gh<_i110.DashBoardRepository>()));
    gh.lazySingleton<_i127.HomeWorkReportsUseCase>(() =>
        _i127.HomeWorkReportsUseCase(
            homeWorkNotesRepository: gh<_i102.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i128.GetHomeWorkDetails>(() => _i128.GetHomeWorkDetails(
        homeWorkNotesRepository: gh<_i102.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i129.NotesReportsUseCase>(() => _i129.NotesReportsUseCase(
        homeWorkNotesRepository: gh<_i102.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i130.GetNoteReportDetails>(() =>
        _i130.GetNoteReportDetails(
            homeWorkNotesRepository: gh<_i102.HomeWorkNotesRepository>()));
    gh.factory<_i131.GetNoticeBoardPopUp>(
        () => _i131.GetNoticeBoardPopUp(gh<_i117.NoticeRepository>()));
    gh.factory<_i132.AddOnBloc>(() => _i132.AddOnBloc(
          gh<_i115.GetAllAddOnUseCase>(),
          gh<_i116.GetAddOnDetailUseCase>(),
        ));
    gh.singleton<_i133.SignOutUseCase>(
        () => _i133.SignOutUseCase(gh<_i113.AuthRepository>()));
    gh.lazySingleton<_i134.GetUserInfoUseCase>(
        () => _i134.GetUserInfoUseCase(gh<_i113.AuthRepository>()));
    gh.lazySingleton<_i135.LoginUseCase>(
        () => _i135.LoginUseCase(gh<_i113.AuthRepository>()));
    gh.lazySingleton<_i136.SaveUserInfoUseCase>(
        () => _i136.SaveUserInfoUseCase(gh<_i113.AuthRepository>()));
    gh.factory<_i137.HomeBloc>(() => _i137.HomeBloc(
          gh<_i81.GetAddOnUsecase>(),
          gh<_i134.GetUserInfoUseCase>(),
          gh<_i82.PostfeedbackUsecase>(),
        ));
    gh.factory<_i138.DashboardBloc>(() => _i138.DashboardBloc(
          gh<_i123.FetchWordThoughtUseCase>(),
          gh<_i134.GetUserInfoUseCase>(),
          gh<_i126.GetTermDetailsUsecase>(),
          gh<_i125.GetScoreboardDetailsUsecase>(),
        ));
    gh.factory<_i139.NoticeBloc>(() => _i139.NoticeBloc(
          gh<_i131.GetNoticeBoardPopUp>(),
          gh<_i120.GetAllNoticeUseCase>(),
        ));
    gh.factory<_i140.AcademicBloc>(() => _i140.AcademicBloc(
          gh<_i51.GetDivisionDetailsUseCase>(),
          getClassInforUseCase: gh<_i80.GetClassInforUseCase>(),
          getUserInfoUseCase: gh<_i134.GetUserInfoUseCase>(),
    ...
    gh.factory<_i141.DrawerBloc>(() => _i141.DrawerBloc(
          gh<_i74.GetNewsBoardUseCase>(),
          gh<_i134.GetUserInfoUseCase>(),
          gh<_i124.GetRoleMenuUsecase>(),
        ));
    gh.factory<_i142.HomeWorkNotesBloc>(() => _i142.HomeWorkNotesBloc(
          gh<_i127.HomeWorkReportsUseCase>(),
          gh<_i134.GetUserInfoUseCase>(),
          gh<_i129.NotesReportsUseCase>(),
          gh<_i130.GetNoteReportDetails>(),
          gh<_i128.GetHomeWorkDetails>(),
        ));
    gh.factory<_i143.PaymentBloc>(() => _i143.PaymentBloc(
          gh<_i86.GetPaymentDashboardUsecase>(),
          gh<_i134.GetUserInfoUseCase>(),
          gh<_i72.GetPaymentFinalAmountUsecase>(),
          gh<_i73.GetPaymentOrderIdUsecase>(),
          gh<_i88.GetPaymentTokenUsecase>(),
          gh<_i85.GetPaymentCompleteResponseUsecase>(),
          gh<_i89.PostPaymentStatusUpdateUsecase>(),
          gh<_i90.SavePaymentResponseUsecase>(),
          gh<_i87.GetPaymentFeeReceiptUsecase>(),
        ));
    return this;
  }
}
