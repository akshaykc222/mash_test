...
import '../mash/data/repositories/auth_repository_impl.dart' as _i86;
import '../mash/data/repositories/chat_repository_impl.dart' as _i29;
import '../mash/data/repositories/dash_board_repository_impl.dart' as _i84;
...
import '../mash/data/repositories/home_work_repository_impl.dart' as _i82;
import '../mash/data/repositories/id_request_type_repo_impl.dart' as _i68;
import '../mash/data/repositories/notice_repository_impl.dart' as _i88;
...
import '../mash/domain/repositories/auth_repository.dart' as _i85;
import '../mash/domain/repositories/chat_repository.dart' as _i28;
import '../mash/domain/repositories/dash_board_repository.dart' as _i83;
...
import '../mash/domain/repositories/home_work_notes_repository.dart' as _i81;
import '../mash/domain/repositories/id_request_repository.dart' as _i67;
import '../mash/domain/repositories/notice_repository.dart' as _i87;
...
import '../mash/domain/use_cases/auth/get_user_info_use_case.dart' as _i101;
import '../mash/domain/use_cases/auth/login_use_case.dart' as _i102;
import '../mash/domain/use_cases/auth/save_user_info_use_case.dart' as _i103;
import '../mash/domain/use_cases/auth/sign_out_use_case.dart' as _i100;
import '../mash/domain/use_cases/chat/add_chat_room_use_case.dart' as _i72;
import '../mash/domain/use_cases/chat/get_chat_rooms_use_case.dart' as _i70;
import '../mash/domain/use_cases/chat/get_chat_use_case.dart' as _i73;
import '../mash/domain/use_cases/chat/get_group_members_use_case.dart' as _i74;
import '../mash/domain/use_cases/chat/get_users_use_case.dart' as _i75;
import '../mash/domain/use_cases/chat/send_message_use_case.dart' as _i71;
import '../mash/domain/use_cases/chat/update_message_use_case.dart' as _i76;
import '../mash/domain/use_cases/chat/update_room_use_case.dart' as _i77;
...
import '../mash/domain/use_cases/dashboard/get_digital_library_use_case.dart'
    as _i89;
import '../mash/domain/use_cases/dashboard/get_role_menu_usecase.dart' as _i94;
import '../mash/domain/use_cases/drawer_menu_items_repository/get_news_board_usecase.dart'
    as _i60;
import '../mash/domain/use_cases/home/get_add_on_usecase.dart' as _i65;
import '../mash/domain/use_cases/home/post_feed_use_case.dart' as _i66;
...
import '../mash/domain/use_cases/id_request/id_request_type_usecase.dart'
    as _i91;
import '../mash/domain/use_cases/id_request/post_id_request.dart' as _i92;
import '../mash/domain/use_cases/notice/get_notice_pop_up_usecase.dart' as _i99;
import '../mash/domain/use_cases/notice/notice_all_usecase.dart' as _i90;
...
import '../mash/presentation/manager/bloc/notice_bloc/notice_bloc.dart'
    as _i104;
import '../mash/presentation/manager/bloc/payment/payment_bloc.dart' as _i106;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i58.GetSyllabusUseCase>(() => _i58.GetSyllabusUseCase(
        academicRepository: gh<_i34.AcademicRepository>()));
    gh.lazySingleton<_i59.GetPaymentFinalAmountUsecase>(() =>
        _i59.GetPaymentFinalAmountUsecase(
            paymentRepository: gh<_i39.PaymentRepository>()));
    gh.lazySingleton<_i60.GetNewsBoardUseCase>(() => _i60.GetNewsBoardUseCase(
        drawerMenuItemsRepository: gh<_i44.DrawerMenuItemsRepository>()));
    gh.lazySingleton<_i61.GetTeacherRatingUseCase>(
        () => _i61.GetTeacherRatingUseCase(gh<_i21.TeacherRepository>()));
    gh.lazySingleton<_i62.PostTeacherRatingUseCase>(
        () => _i62.PostTeacherRatingUseCase(gh<_i21.TeacherRepository>()));
    gh.lazySingleton<_i63.GetTeacherRatingQuestionsUseCase>(() =>
        _i63.GetTeacherRatingQuestionsUseCase(gh<_i21.TeacherRepository>()));
    gh.factory<_i64.GetClassInforUseCase>(
        () => _i64.GetClassInforUseCase(gh<_i34.AcademicRepository>()));
    gh.lazySingleton<_i65.GetAddOnUsecase>(
        () => _i65.GetAddOnUsecase(homeRepository: gh<_i49.HomeRepository>()));
    gh.lazySingleton<_i66.PostfeedbackUsecase>(() =>
        _i66.PostfeedbackUsecase(homeRepository: gh<_i49.HomeRepository>()));
    gh.lazySingleton<_i67.IdRequestRepository>(
        () => _i68.IdRequestRepoImpl(gh<_i24.IdRequestTypeDataSource>()));
    gh.factory<_i69.GetPaymentDashboardUsecase>(
        () => _i69.GetPaymentDashboardUsecase(gh<_i39.PaymentRepository>()));
    gh.singleton<_i70.GetChatRoomsUseCase>(
        () => _i70.GetChatRoomsUseCase(gh<_i28.ChatRepository>()));
    gh.singleton<_i71.SendMessageUserCase>(
        () => _i71.SendMessageUserCase(gh<_i28.ChatRepository>()));
    gh.factory<_i72.AddChatRoomUseCase>(
        () => _i72.AddChatRoomUseCase(gh<_i28.ChatRepository>()));
    gh.factory<_i73.GetChatUseCase>(
        () => _i73.GetChatUseCase(gh<_i28.ChatRepository>()));
    gh.factory<_i74.GetUserMembersUseCase>(
        () => _i74.GetUserMembersUseCase(gh<_i28.ChatRepository>()));
    gh.factory<_i75.GetUsersUseCase>(
        () => _i75.GetUsersUseCase(gh<_i28.ChatRepository>()));
    gh.factory<_i76.UpdateMessageUseCase>(
        () => _i76.UpdateMessageUseCase(gh<_i28.ChatRepository>()));
    gh.factory<_i77.UpdateRoomUseCase>(
        () => _i77.UpdateRoomUseCase(gh<_i28.ChatRepository>()));
    gh.lazySingleton<_i78.GetDailyTimeTableUseCase>(
        () => _i78.GetDailyTimeTableUseCase(gh<_i25.TimeTableRepository>()));
    gh.lazySingleton<_i79.GetOfflineExamTermsUseCase>(
        () => _i79.GetOfflineExamTermsUseCase(gh<_i25.TimeTableRepository>()));
    gh.lazySingleton<_i80.GetOfflineExamTimeTableUseCase>(() =>
        _i80.GetOfflineExamTimeTableUseCase(gh<_i25.TimeTableRepository>()));
    gh.lazySingleton<_i81.HomeWorkNotesRepository>(() =>
        _i82.HomeWorkNotesReportRepositoryImpl(
            homeWorkNotesRemoteDataSource:
                gh<_i51.HomeWorkNotesRemoteDataSource>()));
    gh.lazySingleton<_i83.DashBoardRepository>(() => _i84.DashBoardRepoImpl(
    ...
    gh.lazySingleton<_i87.NoticeRepository>(() => _i88.NoticeRepositoryImpl(
        noticeRemoteDataSource: gh<_i53.NoticeRemoteDataSource>()));
    gh.singleton<_i89.DigitalLibraryUseCase>(
        () => _i89.DigitalLibraryUseCase(gh<_i83.DashBoardRepository>()));
    gh.factory<_i90.GetAllNoticeUseCase>(() => _i90.GetAllNoticeUseCase(
        noticeRepository: gh<_i87.NoticeRepository>()));
    gh.lazySingleton<_i91.GetIdRequestTypeUseCase>(
        () => _i91.GetIdRequestTypeUseCase(gh<_i67.IdRequestRepository>()));
    gh.lazySingleton<_i92.PostIdRequestUseCase>(
        () => _i92.PostIdRequestUseCase(gh<_i67.IdRequestRepository>()));
    gh.factory<_i93.FetchWordThoughtUseCase>(
        () => _i93.FetchWordThoughtUseCase(gh<_i83.DashBoardRepository>()));
    gh.factory<_i94.GetRoleMenuUsecase>(
        () => _i94.GetRoleMenuUsecase(gh<_i83.DashBoardRepository>()));
    gh.lazySingleton<_i95.HomeWorkReportsUseCase>(() =>
        _i95.HomeWorkReportsUseCase(
            homeWorkNotesRepository: gh<_i81.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i96.GetHomeWorkDetails>(() => _i96.GetHomeWorkDetails(
        homeWorkNotesRepository: gh<_i81.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i97.NotesReportsUseCase>(() => _i97.NotesReportsUseCase(
        homeWorkNotesRepository: gh<_i81.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i98.GetNoteReportDetails>(() => _i98.GetNoteReportDetails(
        homeWorkNotesRepository: gh<_i81.HomeWorkNotesRepository>()));
    gh.factory<_i99.GetNoticeBoardPopUp>(
        () => _i99.GetNoticeBoardPopUp(gh<_i87.NoticeRepository>()));
    gh.singleton<_i100.SignOutUseCase>(
        () => _i100.SignOutUseCase(gh<_i85.AuthRepository>()));
    gh.lazySingleton<_i101.GetUserInfoUseCase>(
        () => _i101.GetUserInfoUseCase(gh<_i85.AuthRepository>()));
    gh.lazySingleton<_i102.LoginUseCase>(
        () => _i102.LoginUseCase(gh<_i85.AuthRepository>()));
    gh.lazySingleton<_i103.SaveUserInfoUseCase>(
        () => _i103.SaveUserInfoUseCase(gh<_i85.AuthRepository>()));
    gh.factory<_i104.NoticeBloc>(() => _i104.NoticeBloc(
          gh<_i99.GetNoticeBoardPopUp>(),
          gh<_i90.GetAllNoticeUseCase>(),
        ));
    gh.factory<_i105.HomeBloc>(() => _i105.HomeBloc(
          gh<_i65.GetAddOnUsecase>(),
          gh<_i101.GetUserInfoUseCase>(),
          gh<_i66.PostfeedbackUsecase>(),
        ));
    gh.factory<_i106.PaymentBloc>(() => _i106.PaymentBloc(
          gh<_i69.GetPaymentDashboardUsecase>(),
          gh<_i101.GetUserInfoUseCase>(),
          gh<_i59.GetPaymentFinalAmountUsecase>(),
        ));
    gh.factory<_i107.AcademicBloc>(() => _i107.AcademicBloc(
          gh<_i43.GetDivisionDetailsUseCase>(),
          getClassInforUseCase: gh<_i64.GetClassInforUseCase>(),
          getUserInfoUseCase: gh<_i101.GetUserInfoUseCase>(),
    ...
    gh.factory<_i108.DrawerBloc>(() => _i108.DrawerBloc(
          gh<_i60.GetNewsBoardUseCase>(),
          gh<_i101.GetUserInfoUseCase>(),
          gh<_i94.GetRoleMenuUsecase>(),
        ));
    gh.factory<_i109.HomeWorkNotesBloc>(() => _i109.HomeWorkNotesBloc(
          gh<_i95.HomeWorkReportsUseCase>(),
          gh<_i101.GetUserInfoUseCase>(),
          gh<_i97.NotesReportsUseCase>(),
          gh<_i98.GetNoteReportDetails>(),
          gh<_i96.GetHomeWorkDetails>(),
        ));
    gh.factory<_i110.DashboardBloc>(() => _i110.DashboardBloc(
          gh<_i93.FetchWordThoughtUseCase>(),
          gh<_i101.GetUserInfoUseCase>(),
        ));
    return this;
  }
