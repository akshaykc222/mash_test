...
import '../mash/presentation/manager/bloc/dashboard_bloc/dashboard_bloc.dart'
    as _i80;
import '../mash/presentation/manager/bloc/drawer_bloc/drawer_bloc.dart' as _i78;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i68.NotesReportsUseCase>(() => _i68.NotesReportsUseCase(
        homeWorkNotesRepository: gh<_i56.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i69.GetNoteReportDetails>(() => _i69.GetNoteReportDetails(
        homeWorkNotesRepository: gh<_i56.HomeWorkNotesRepository>()));
    gh.lazySingleton<_i70.GetHomeWorkDetails>(() => _i70.GetHomeWorkDetails(
        homeWorkNotesRepository: gh<_i56.HomeWorkNotesRepository>()));
    ...
    gh.factory<_i77.AcademicBloc>(() => _i77.AcademicBloc(
    ...
    gh.factory<_i78.DrawerBloc>(() => _i78.DrawerBloc(
          gh<_i44.GetNewsBoardUseCase>(),
          gh<_i73.GetUserInfoUseCase>(),
          gh<_i66.GetRoleMenuUsecase>(),
        ));
    gh.factory<_i79.HomeWorkNotesBloc>(() => _i79.HomeWorkNotesBloc(
          gh<_i67.HomeWorkReportsUseCase>(),
          gh<_i73.GetUserInfoUseCase>(),
          gh<_i68.NotesReportsUseCase>(),
          gh<_i69.GetNoteReportDetails>(),
          gh<_i70.GetHomeWorkDetails>(),
        ));
