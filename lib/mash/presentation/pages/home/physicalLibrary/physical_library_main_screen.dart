                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.filter_alt_sharp,size: 15,color: AppColors.white,),
                                spacerWidth4,
                                Text('Filter',style: TextStyle(color: AppColors.white,fontWeight: FontWeight.w500),),
                              ],
                            ),
                          ),
                        ),
                      ),
                      VerticalDivider(color: AppColors.grey700,width: 2,),
                      Expanded(
                        child: Container(
                          decoration: BoxDecoration(
                          ...
                          child: Center(
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(Icons.search,size: 15,color: AppColors.white,),
                                spacerWidth4,
                                Text('Search',style: TextStyle(color: AppColors.white,fontWeight: FontWeight.w500),),
                              ],
                            ),
                          ),
                        ),
