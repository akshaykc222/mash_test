  ...
  leaveBody() {
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          children: [
            _leaveCard(()=>GoRouter.of(context).pushNamed(AppPages.leaveApplyScreen), AppAssets.leaveApply, 'APPLY LEAVE'),
            _leaveCard(()=>GoRouter.of(context).pushNamed(AppPages.leaveStatusScreen), AppAssets.leaveStatus, 'STATUS'),
            spacer20,
