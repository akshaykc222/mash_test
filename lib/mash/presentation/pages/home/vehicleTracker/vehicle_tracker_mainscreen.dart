...
class _VehicleTrackerBodyState extends State<VehicleTrackerBody> {
  ...
  void getPolyLines() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(AppConstants.ApiKey,
        ...
        children: [
          GoogleMap(
            padding: EdgeInsets.only(bottom: 80),
              initialCameraPosition: const CameraPosition(target: sourceLocation,zoom: 14.5),
              ...
              polylines: {
                Polyline(
                    color: Colors.blue,
                    width: 5,
                    polylineId: const PolylineId("route"),points: polylineCoordinates)
              },
            ),
          Positioned(
            top: 20,
            child: SizedBox(
              ...
              child: const Row(
                ...
                children: [
                  Expanded(child: TrackerDetailWidget(detail: '17'' ''Min', descTitle: AppStrings.time,)),
                  Expanded(child: TrackerDetailWidget(detail: '8.0'' ''KM', descTitle: AppStrings.distance,)),
                  Expanded(child: TrackerDetailWidget(detail: '\u24D8', descTitle: AppStrings.info,)),
                ],
              ),
            ),
          ),
...
alignment: Alignment.bottomCenter,
            child: Container(
              ...
              child: Align(
                ...
                // crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Text(AppStrings.transIncharge,style: TextStyle(color: AppColors.primaryColor,fontSize: 22,fontWeight: FontWeight.w600),),
                  const Text('+91 - 8075776255',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600)),
                ],
                            ),
              ),
            ),
