  ...
  selectClassTitle() {
    return const Padding(
      ...
      child:  Align(
          ...
          child: Text('Select Class',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 20),)),
    );
  }

  dropDown() {
    List classes = ['Pre-KG','LKG','UKG','I','II','III','IV','V','VI','VII','VIII','IX','X','XI'];
    ...
    return Padding(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: index == selectedIndex ? Colors.purple : Colors.white, // Set button color dynamically
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(25.0),
          ),
        ),
        child: Text(title,style: TextStyle(fontWeight: FontWeight.w600,color: index == selectedIndex ? Colors.white : Colors.purple),),
      ),
    );
  }
    ...
    return Container(
      ...
      margin: const EdgeInsets.symmetric(horizontal: 15),
        ...
        child: Padding(
          ...
          child: ListTile(
            onTap: ()=> GoRouter.of(context).pushNamed(AppPages.academicDetailLibraryScreen),
