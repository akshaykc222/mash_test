...
abstract class $DashboardStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ResponseClassify<WordThoughtsEntity>? wordThoughtResponse});
}
...
class _$DashboardStateImpl implements _DashboardState {
  const _$DashboardStateImpl({required this.wordThoughtResponse});
  ...
  @override
  String toString() {
    return 'DashboardState(wordThoughtResponse: $wordThoughtResponse)';
  }
...
abstract class _DashboardState implements DashboardState {
  const factory _DashboardState(
      {required final ResponseClassify<WordThoughtsEntity>?
          wordThoughtResponse}) = _$DashboardStateImpl;
