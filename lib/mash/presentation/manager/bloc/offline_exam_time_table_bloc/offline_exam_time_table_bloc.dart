...
@lazySingleton
@injectable
class OfflineExamTimeTableBloc
    extends Bloc<OfflineExamTimeTableEvent, OfflineExamTimeTableState> {
  ...
  FutureOr<void> _getOfflineExamTerm(_GetOfflineExamTerms event,
      Emitter<OfflineExamTimeTableState> emit) async {
    ...
    try {
      ...
      if (response.isNotEmpty) {
        add(OfflineExamTimeTableEvent.getOfflineExamTimeTable(
